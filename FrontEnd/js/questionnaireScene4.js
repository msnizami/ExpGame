...
class QuestionnaireScene4 extends Phaser.Scene {
	...
	create() {
		...
		// add item 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.25, item9, { fontFamily: 'monogram', fontSize: '17px', fontStyle: "bold", color: '#000000' });
		...
		// add item 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.425, item10, { fontFamily: 'monogram', fontSize: '17px', fontStyle: "bold", color: '#000000' });
	...
	onBtnContinue() {
		...
		[this.item10Var1Checked, this.item10Var2Checked, this.item10Var3Checked, this.item10Var4Checked, this.item10Var5Checked, this.item10Var6Checked].every(a => a == false)) {
			...
			var questionnaireScene5 = new QuestionnaireScene5(this.gameData);
