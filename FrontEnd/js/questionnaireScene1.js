...
class QuestionnaireScene1 extends Phaser.Scene {
	...
	create() {
		...
		// Don't know
		this.add.text(window.innerWidth * 0.60, window.innerHeight * 0.425, 'I do not know.', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// Don't know
		this.add.text(window.innerWidth * 0.60, window.innerHeight * 0.675, 'I do not know.', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
	...
	logAnswers() {
		this.gameData.api.logQuestionnaire(0, this.item1Var1Checked, this.item1Var2Checked, this.item1Var3Checked, this.item1Var4Checked, this.item1Var5Checked, this.item1Var6Checked);
		this.gameData.api.logQuestionnaire(1, this.item2Var1Checked, this.item2Var2Checked, this.item2Var3Checked, this.item2Var4Checked, this.item2Var5Checked, this.item2Var6Checked);
	}
	...
	onBtnContinue() {
		if ([this.item1Var1Checked, this.item1Var2Checked, this.item1Var3Checked, this.item1Var4Checked, this.item1Var5Checked, this.item1Var6Checked].every(a => a == false) ||
			...
			var questionnaireScene2 = new QuestionnaireScene2(this.gameData);
