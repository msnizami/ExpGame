...
class QuestionnaireScene4 extends Phaser.Scene {
	...
	create() {
		...
		// add item 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.08, itemGender, { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		// option 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.11, 'Female', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite1 = this.add.sprite(window.innerWidth * 0.04, window.innerHeight * 0.15, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 2
		this.add.text(window.innerWidth * 0.150, window.innerHeight * 0.11, 'Male', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite2 = this.add.sprite(window.innerWidth * 0.16, window.innerHeight * 0.15, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 3
		this.add.text(window.innerWidth * 0.265, window.innerHeight * 0.11, 'Transgender\nfemale', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite3 = this.add.sprite(window.innerWidth * 0.31, window.innerHeight * 0.16, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 4
		this.add.text(window.innerWidth * 0.385, window.innerHeight * 0.11, 'Transgender\nmale', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite4 = this.add.sprite(window.innerWidth * 0.44, window.innerHeight * 0.16, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 5
		this.add.text(window.innerWidth * 0.505, window.innerHeight * 0.11, 'Non-binary\ngender', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite5 = this.add.sprite(window.innerWidth * 0.56, window.innerHeight * 0.16, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 6
		this.add.text(window.innerWidth * 0.65, window.innerHeight * 0.11, 'Not listed', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite6 = this.add.sprite(window.innerWidth * 0.67, window.innerHeight * 0.15, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// Don't know
		this.add.text(window.innerWidth * 0.755, window.innerHeight * 0.11, 'I prefer not to answer.', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite7 = this.add.sprite(window.innerWidth * 0.80, window.innerHeight * 0.15, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// add item 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.2, itemAge, { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		// option 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.24, '18-24y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemAgeSprite1 = this.add.sprite(window.innerWidth * 0.04, window.innerHeight * 0.28, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 2
		this.add.text(window.innerWidth * 0.125, window.innerHeight * 0.24, '25-34y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemAgeSprite2 = this.add.sprite(window.innerWidth * 0.14, window.innerHeight * 0.28, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 3
		this.add.text(window.innerWidth * 0.225, window.innerHeight * 0.24, '35-44y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemAgeSprite3 = this.add.sprite(window.innerWidth * 0.24, window.innerHeight * 0.28, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 4
		this.add.text(window.innerWidth * 0.325, window.innerHeight * 0.24, '45-54y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemAgeSprite4 = this.add.sprite(window.innerWidth * 0.34, window.innerHeight * 0.28, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 5
		this.add.text(window.innerWidth * 0.425, window.innerHeight * 0.24, '55-64y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemAgeSprite5 = this.add.sprite(window.innerWidth * 0.44, window.innerHeight * 0.28, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 6
		this.add.text(window.innerWidth * 0.525, window.innerHeight * 0.24, '65y and over', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemAgeSprite6 = this.add.sprite(window.innerWidth * 0.54, window.innerHeight * 0.28, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// Don't know
		this.add.text(window.innerWidth * 0.625, window.innerHeight * 0.24, 'I prefer not to answer.', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemAgeSprite7 = this.add.sprite(window.innerWidth * 0.64, window.innerHeight * 0.28, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// add item 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.71, itemEng, { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		// option 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.75, 'Beginner(A1)', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemEngSprite1 = this.add.sprite(window.innerWidth * 0.04, window.innerHeight * 0.79, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 2
		this.add.text(window.innerWidth * 0.150, window.innerHeight * 0.75, 'Elementary(A2)', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemEngSprite2 = this.add.sprite(window.innerWidth * 0.16, window.innerHeight * 0.79, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 3
		this.add.text(window.innerWidth * 0.265, window.innerHeight * 0.75, 'Intermediate(B1)', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemEngSprite3 = this.add.sprite(window.innerWidth * 0.29, window.innerHeight * 0.79, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 4
		this.add.text(window.innerWidth * 0.385, window.innerHeight * 0.75, 'Upper-inter(B1)', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemEngSprite4 = this.add.sprite(window.innerWidth * 0.42, window.innerHeight * 0.79, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 5
		this.add.text(window.innerWidth * 0.505, window.innerHeight * 0.75, 'Advanced(C1)', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemEngSprite5 = this.add.sprite(window.innerWidth * 0.54, window.innerHeight * 0.79, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 6
		this.add.text(window.innerWidth * 0.6, window.innerHeight * 0.75, 'Native', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemEngSprite6 = this.add.sprite(window.innerWidth * 0.63, window.innerHeight * 0.79, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// Don't know
		this.add.text(window.innerWidth * 0.68, window.innerHeight * 0.75, 'I prefer not to answer.', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemEngSprite7 = this.add.sprite(window.innerWidth * 0.7, window.innerHeight * 0.79, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		var buttonContainer = this.add.container(window.innerWidth * 0.9, window.innerHeight * 0.75, [buttonContinue, textContinue])
	...
	onBtnContinue() {
		...
		[this.itemEngVar1Checked, this.itemEngVar2Checked, this.itemEngVar3Checked, this.itemEngVar4Checked, this.itemEngVar5Checked, this.itemEngVar6Checked, this.itemEngVar7Checked].every(a => a == false)
			...
			this.logAnswers();
			// console.log(this.itemAgeVar1Checked, this.itemAgeVar2Checked, this.itemEduVar1Checked, this.itemEduVar2Checked)
