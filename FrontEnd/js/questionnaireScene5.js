...
class QuestionnaireScene4 extends Phaser.Scene {
	...
	create() {
		...
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.125, demographics, { fontFamily: 'monogram', fontSize: '17px', fontStyle: "bold", color: '#000000' });
		...
		// add item 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.175, itemGender, { fontFamily: 'monogram', fontSize: '17px', fontStyle: "bold", color: '#000000' });

		// option 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.225, 'Female', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 2
		this.add.text(window.innerWidth * 0.150, window.innerHeight * 0.225, 'Male', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 3
		this.add.text(window.innerWidth * 0.265, window.innerHeight * 0.21, 'Transgender\nfemale', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 4
		this.add.text(window.innerWidth * 0.385, window.innerHeight * 0.21, 'Transgender\nmale', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 5
		this.add.text(window.innerWidth * 0.505, window.innerHeight * 0.18, 'Non-binary /\n gender non-\nconforming', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite5 = this.add.sprite(window.innerWidth * 0.54, window.innerHeight * 0.275, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// option 6
		this.add.text(window.innerWidth * 0.65, window.innerHeight * 0.225, 'Not listed', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite6 = this.add.sprite(window.innerWidth * 0.67, window.innerHeight * 0.275, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// Don't know
		this.add.text(window.innerWidth * 0.755, window.innerHeight * 0.225, 'I prefer not to answer.', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });

		var itemGenderSprite7 = this.add.sprite(window.innerWidth * 0.80, window.innerHeight * 0.275, 'checkbox', 0).setScale(0.4).setInteractive();
		...
		// add item 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.35, itemAge, { fontFamily: 'monogram', fontSize: '17px', fontStyle: "bold", color: '#000000' });

		// option 1
		this.add.text(window.innerWidth * 0.025, window.innerHeight * 0.4, '18-24y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 2
		this.add.text(window.innerWidth * 0.125, window.innerHeight * 0.4, '25-34y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 3
		this.add.text(window.innerWidth * 0.225, window.innerHeight * 0.4, '35-44y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 4
		this.add.text(window.innerWidth * 0.325, window.innerHeight * 0.4, '45-54y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 5
		this.add.text(window.innerWidth * 0.425, window.innerHeight * 0.4, '55-64y', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// option 6
		this.add.text(window.innerWidth * 0.525, window.innerHeight * 0.4, '65y and over', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
		...
		// Don't know
		this.add.text(window.innerWidth * 0.625, window.innerHeight * 0.4, 'I prefer not to answer.', { fontFamily: 'monogram', fontSize: '17px', color: '#000000' });
